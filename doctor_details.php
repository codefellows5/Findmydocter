 ...
 if(isset($_POST['submit']))
  {
    ...
    $qy="insert into doctor_details(name,experience,expertise,hospital,contact,time_from,time_till,image) values('$name','$experience','$expertise','$hospital','$contact','$time_from','$time_till','$path')";
    mysqli_query($con,$qy);
...
<div class="container">
            <form class="form-horizontal" action="doctor_details.php" method="POST" role="form" enctype="multipart/form-data">
                ...
                <button type="submit" value="Register" name="submit" style=" background-color: #FFA943;margin-top: 5%; width: 300px; ;" class="btn btn-block" >Register</button>
            </form> <!-- /form -->
        </div> <!-- ./container -->
